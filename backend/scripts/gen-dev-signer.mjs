...
//
// Output:
//   - .env.local entry: WEAVEOS_DEV_SIGNER_PRIVKEY=<hex>
...
console.log("=== weaveOS dev signer keypair ===");
console.log();
console.log("Private (HEX, 32 bytes) — KEEP SECRET, add to .env.local:");
console.log(`WEAVEOS_DEV_SIGNER_PRIVKEY=${privHex}`);
console.log();
...
const out = {
  ...
  notes: [
    "Private key (WEAVEOS_DEV_SIGNER_PRIVKEY) lives in .env.local only — gitignored.",
