...
import {
  ...
  UserGroupIcon, DeveloperIcon, SettingsIcon,
...
const PAGE_META: Record<string, PageMeta> = {
  "/":              { title: "Overview",       description: "Your platform at a glance",                              icon: DashboardSquareIcon     },
  "/workflows":     { title: "Workflows",      description: "Monitor and manage all workflow executions",             icon: WorkflowCircleIcon      },
  "/quotes":        { title: "Quotes",         description: "Build and manage pricing quotes for customers",          icon: LegalDocumentIcon       },
  "/settlement":    { title: "Settlement",     description: "Track payouts, escrow, and disputes",                   icon: BankIcon                },
  "/margin":        { title: "Margin",         description: "Analyse profitability across customers and workflows",   icon: TrendingUpDownIcon      },
  "/pricing-intel": { title: "Pricing Intel",  description: "Competitive benchmarks and demand elasticity",          icon: PresentationBarChartIcon},
  "/customers":     { title: "Customers",      description: "Manage customer relationships and billing",             icon: UserGroupIcon           },
  "/developer":     { title: "Developer",      description: "API keys, webhooks, and SDK configuration",             icon: DeveloperIcon           },
  "/settings":      { title: "Settings",       description: "Platform preferences and account configuration",        icon: SettingsIcon            },
};
    ...
    <>
      ...
      <div className="flex items-center justify-between px-4 md:px-6 pt-4 pb-3 shrink-0">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          {/* Sui Explorer — workflow detail only */}
          {isWorkflowDetail && (
