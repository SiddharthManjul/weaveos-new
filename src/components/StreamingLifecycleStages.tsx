...
const STAGES: StageDef[] = [
  ...
  { key: "workflow", title: "Payment + Workflow", hint: "PTB locks SUI escrow + creates the Workflow object", icon: WorkflowCircleIcon },
  { key: "execution", title: "Execution", hint: "Agent runs off-chain; SDK posts cost items + trace blob", icon: FileSearchIcon },
  { key: "verify", title: "Verifier", hint: "DSL eval, Walrus upload, BCS encode, ed25519 sign", icon: Settings01Icon },
  ...
  { key: "dispute_window", title: "Dispute window", hint: "Customer can challenge here", icon: HourglassIcon },
