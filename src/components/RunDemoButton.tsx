    ...
    <div className="relative inline-flex">
      ...
      {menuOpen && (
        ...
        >
          ...
          >
            <span className="font-medium">Success path</span>
            <span className="block text-[11px] text-[#5a5a5a]">criteria pass → atomic split</span>
          </button>
          <button
            onClick={() => {
              setMode("failure");
          ...
          >
            <span className="font-medium">Failure path</span>
            <span className="block text-[11px] text-[#5a5a5a]">criteria fail → full refund</span>
          </button>
        </div>
      )}
