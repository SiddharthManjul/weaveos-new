...
export const metadata = {
  title: "Terms of Service — WeaveOS",
  description: "The rules governing your use of the WeaveOS platform.",
};
...
export default function TermsPage() {
  return (
    ...
    >
      ...
      <LP>
        These Terms of Service (&ldquo;Terms&rdquo;) form a legally binding agreement between you and WeaveOS (&ldquo;WeaveOS&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;) governing your access to and use of the platform available at weaveos.xyz and all associated APIs, SDKs, and services (collectively, the &ldquo;Service&rdquo;). Please read them carefully.
      </LP>
      <LP>
      ...
      <LSection title="2. Description of Service">
        ...
        <LList>
          ...
          <LItem>USDC escrow and atomic multi-party settlement on Sui</LItem>
      ...
      <LSection title="3. Account Registration and Security">
        ...
        <LList>
          ...
          <LItem>Notify us immediately at{" "}
            <a href="mailto:team@weaveos.xyz" className="text-white underline underline-offset-2">team@weaveos.xyz</a>{" "}
      ...
      <LSection title="5. Blockchain Transactions and USDC Escrow">
        ...
        <LList>
          ...
          <LItem>USDC is a third-party stablecoin issued by Circle. Its value and availability are not guaranteed by WeaveOS.</LItem>
      ...
      <LSection title="6. Fees and Billing">
        ...
        <LP>
          In addition to any subscription fee, we charge a percentage of Gross Merchandise Value (&ldquo;GMV&rdquo;) — the total value of workflows that successfully complete and settle through WeaveOS. The applicable rate is shown in your plan details. GMV fees are charged only on successfully settled workflows; failed workflows, refunds, and unresolved disputes are excluded.
        </LP>
      ...
      <LSection title="7. Intellectual Property">
        ...
        <LP>
          You retain all ownership rights in the data, content, and workflow configurations you submit to the Service (&ldquo;Customer Data&rdquo;). You grant WeaveOS a non-exclusive, worldwide licence to process, store, and use Customer Data solely to provide and improve the Service for you. We will not use your Customer Data to train AI models or share it with third parties except as described in our Privacy Policy.
        </LP>
      ...
      <LSection title="9. Disclaimers">
        <LP>
          THE SERVICE IS PROVIDED &ldquo;AS IS&rdquo; AND &ldquo;AS AVAILABLE&rdquo; WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED. TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, WEAVEOS DISCLAIMS ALL WARRANTIES, INCLUDING IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT.
        </LP>
        <LP>
      ...
      <LSection title="10. Limitation of Liability">
        ...
        <LP>
          WEAVEOS&rsquo;S TOTAL AGGREGATE LIABILITY ARISING OUT OF OR IN CONNECTION WITH THESE TERMS OR THE SERVICE WILL NOT EXCEED THE GREATER OF: (a) THE TOTAL FEES PAID BY YOU TO WEAVEOS IN THE TWELVE MONTHS IMMEDIATELY PRECEDING THE EVENT GIVING RISE TO THE CLAIM; OR (b) USD 100.
        </LP>
        <LP>
