...
export const metadata = {
  title: "About — WeaveOS",
  description: "We built WeaveOS because AI teams deserve to know what they're selling before they sell it.",
};
...
export default function AboutPage() {
  return (
    ...
    >
      ...
      <p>
        WeaveOS exists to close that gap. We are building the billing and settlement
      ...
      <p>
        WeaveOS is a pricing, escrow, and settlement protocol for AI workflows. The core
      ...
      <p>
        When a customer initiates a workflow, WeaveOS generates a binding quote: a
      ...
      <p>
        Settlement is then triggered automatically. A single atomic transaction on Sui
      ...
      <p>
        The decision to build on Sui was not arbitrary. Multi-party atomic settlement —
      ...
      <p>
        On Sui, a single Programmable Transaction Block can transfer to any number of
        recipients atomically. The settlement logic is a Move smart contract: open,
      ...
      <p>
        WeaveOS ships a success criteria DSL — a structured, machine-readable specification
      ...
      <p>
        ...
        is signed by the enclave and verified by the Move contract before any funds move.
      </p>
      <p>
        ...
        attestation document, to the Move contract — with no trusted intermediary in the path.
        For the hackathon and early integrations, the same pipeline runs with an ed25519 dev
      ...
      <p>
        ...
        That infrastructure did not exist. WeaveOS is that infrastructure.
      </p>
      <p>
      ...
      <p>
        The first version of WeaveOS is settlement infrastructure: quotes, escrow, outcome
        verification, and atomic multi-party payment. That is the foundation — and it is
        running on Sui testnet today.
      </p>
      <p>
      ...
      <p>
        ...
        talk to you. WeaveOS is in early access on Sui testnet. Design partners get
      ...
      <p>
        ...
        <strong>team@weaveos.xyz</strong>. We read everything.
      </p>
    </BlogLayout>
  );
}
