...
export const metadata = {
  title: "Changelog — WeaveOS",
  description: "Product updates, new features, and improvements to WeaveOS.",
};
...
const RELEASES = [
  ...
  },
  {
    ...
    changes: [
      ...
      { type: "new",  text: "Python SDK released. Supports all workflow, quote, and webhook operations. Install with pip install weaveos." },
      ...
      { type: "perf", text: "Sui transaction confirmation now uses parallel witness collection, reducing median settlement finality from 4.2s to 1.8s." },
  ...
  },
  {
    ...
    tagColor: "#22c55e",
    changes: [
      { type: "new",  text: "General availability of WeaveOS on Sui testnet. Fixed and hybrid pricing models available at launch." },
      ...
      { type: "new",  text: "On-chain settlement via the WeaveOS Sui Move contract. Every settled workflow produces a transaction record with ed25519 attestation." },
      ...
      <div className="relative z-10 w-full flex-1 pt-32 pb-24 px-5">
        <div className="max-w-[720px] mx-auto">
          ...
          <p className="mt-3 text-[15px] leading-relaxed max-w-[520px]" style={{ color: "#808080" }}>
            New features, fixes, and improvements to WeaveOS. Subscribe to release
