      ...
      <div className="flex items-center justify-between gap-3 flex-wrap">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-white text-[20px] font-semibold tracking-tight">Agent marketplace</h1>
          </div>
          <p className="text-[#5a5a5a] text-[12px] mt-0.5">
            {list.length} active {list.length === 1 ? "agent" : "agents"} · all on-chain settlements
          </p>
        </div>
        <button
    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        <span className="text-[12px] font-mono text-white whitespace-nowrap">
          {(agent.priceBaseUnits / 1e9).toFixed(3)} SUI
        </span>
      </div>
