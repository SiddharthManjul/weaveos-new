          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-16">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                  ...
                  <Field label="Tell us more">
                    <textarea name="message" value={form.message} onChange={handleInput} rows={5} placeholder="Describe your current billing setup, the problem you're hitting, or what you want to explore with WeaveOS." className="w-full rounded-xl px-4 py-3 text-[14px] text-white placeholder:text-[#3a3a3a] outline-none resize-none transition-colors" style={{ border: "1px solid #1e1e1e", background: "#0a0a0b" }} onFocus={e => (e.currentTarget.style.borderColor = "#3064FF55")} onBlur={e => (e.currentTarget.style.borderColor = "#1e1e1e")} />
                  </Field>
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="rounded-2xl p-6 flex flex-col gap-5" style={{ background: "#0d0d0f", border: "1px solid #1e1e1e" }}>
                ...
                <ContactRow icon={EmailIcon} label="General"      value="team@weaveos.xyz"     href="mailto:team@weaveos.xyz" />
                <ContactRow icon={EmailIcon} label="Partnerships" value="partners@weaveos.xyz"  href="mailto:partners@weaveos.xyz" />
                <ContactRow icon={EmailIcon} label="Security"     value="security@weaveos.xyz"  href="mailto:security@weaveos.xyz" />
              </div>
