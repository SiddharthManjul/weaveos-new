...
const PRICING_FAQS = [
  {
    ...
    a: "GMV is the total value of workflows that successfully complete and settle through WeaveOS. Failed workflows, refunds, and disputes that have not resolved are excluded — you only pay when value actually moves.",
  },
  {
  ...
  return (
    <div className="min-h-full flex flex-col bg-black text-white">
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-[16px] leading-relaxed max-w-[500px] mx-auto" style={{ color: "#808080" }}>
              Start free. Scale on GMV. WeaveOS earns only when your workflows settle — not before.
            </p>
          </div>
      ...
      <FaqSection
        ...
        subtitle="Anything else, reach us at team@weaveos.xyz."
      />
