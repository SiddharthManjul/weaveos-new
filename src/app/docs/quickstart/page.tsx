  ...
  return (
    <DocsLayout>
      <div className="docs-body">
        ...
        <p>
          Install the WeaveOS Node.js SDK from npm. Python and cURL are also supported —
        ...
        <Code lang="bash">export WEAVEOS_API_KEY=sk_test_your_key_here</Code>

        <Callout type="info">
          Use <code>sk_test_</code> keys during development. They behave identically to live
          keys but settlement is simulated against Sui testnet and no real charges occur.
        </Callout>

        <h2>3. Create your first workflow</h2>
        <p>
          Call <code>workflows.create()</code> with a product identifier, a customer ID,
          and the input payload for your AI task. WeaveOS returns an upfront quote — the
...
console.log(workflow.quoted.currency); // USD`}
        ...
        <p>
          ...
          underlying task. WeaveOS tracks costs in real time across all cost layers —
...
console.log(result.settlement.txId); // Sui transaction ID`}
        </Code>
