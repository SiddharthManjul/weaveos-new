...
export const metadata = { title: "Settlement — WeaveOS Docs" };
...
export default function DocsSettlement() {
    ...
    <DocsLayout>
      <div className="docs-body">
        ...
        <p className="mt-3" style={{ color: "#a3a3a3", fontSize: 15 }}>
          Every completed workflow is settled on the Sui blockchain. Settlement
        ...
        <ol>
          ...
          <li>
            ...
            It is signed with the WeaveOS ed25519 signer key.
          </li>
          <li>
          ...
          <li>
            ...
            the WeaveOS Sui smart contract. The transaction is confirmed and a Sui
  ...
  "timestamp": 1716982330
        ...
        <p>
          ...
          built on Sui. Three blobs are uploaded per settlement:
        </p>
        <table>
          <thead>
        ...
        <Callout type="info">
          Blob retention defaults to 5 epochs. On Sui mainnet, one epoch is approximately
        ...
        <p>
          The settlement is verifiable on-chain using the Sui transaction ID returned
          in <code>workflow.settlement.txId</code>. The WeaveOS Move contract records:
        </p>
        <ul>
          ...
          <li>Ed25519 signature from the WeaveOS signer public key</li>
        </ul>
        ...
        <p>
          ...
          pause any pending payouts. The dispute is resolved by the WeaveOS
