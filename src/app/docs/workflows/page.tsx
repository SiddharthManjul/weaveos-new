...
export const metadata = { title: "Workflows — WeaveOS Docs" };
    ...
    <DocsLayout>
      <div className="docs-body">
        ...
        <p className="mt-3" style={{ color: "#a3a3a3", fontSize: 15 }}>
          A workflow is the atomic unit of execution in WeaveOS. Every AI task
...
console.log(workflow.margin.achieved);  // 0.717`}
        ...
        <h2>Cost tracking</h2>
        <p>
          WeaveOS breaks down the cost of every workflow across four layers. This
        ...
        <p>
          WeaveOS emits events at each lifecycle transition. Subscribe to them via
