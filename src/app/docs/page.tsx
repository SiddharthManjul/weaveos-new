...
export const metadata = {
  title: "Introduction — WeaveOS Docs",
  description: "WeaveOS documentation — AI workflow pricing, quotes, settlement, and margin intelligence.",
};
    ...
    <DocsLayout>
      <div className="docs-body">
        ...
        <p className="mt-3" style={{ color: "#a3a3a3", fontSize: 16 }}>
          WeaveOS is an AI workflow pricing and settlement platform. It gives your team
        ...
        <h2>What is WeaveOS?</h2>
        <p>
          Most AI products are priced before their costs are understood. Developers ship
          features, users push edge cases, and margin quietly disappears. WeaveOS solves this
        ...
        <ul>
          ...
          <li>
            <strong>Settlement</strong> — on-chain settlement via the Sui blockchain with
        ...
        <ol>
          <li>
            ...
            product ID, customer ID, and input payload. WeaveOS generates a quote and returns
            the upfront price.
          </li>
          <li>
            <strong>Execute</strong> — your agent or pipeline runs. WeaveOS tracks model
          ...
          <li>
            ...
            and the result is written to the Sui blockchain with a Walrus attestation blob.
        ...
        <h3>Workflows</h3>
        <p>
          A workflow is the atomic unit of work in WeaveOS. It has a lifecycle: <code>Quoted</code> →{" "}
        ...
        <p>
          Every settled workflow produces an on-chain record on the Sui blockchain.
          ...
          and a cryptographic signature from the WeaveOS signer.
          See <Link href="/docs/settlement" className="transition-colors hover:text-white" style={{ color: "#3064FF" }}>Settlement</Link>.
        </p>

        <h2>Environments</h2>
        <p>
          WeaveOS has two environments. Use test keys during development — no real
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td><code>api.weaveos.dev/v1</code></td>
              <td>Sui mainnet</td>
            </tr>
            <tr>
