...
export const metadata = { title: "Webhooks — WeaveOS Docs" };
    ...
    <DocsLayout>
      <div className="docs-body">
        ...
        <p className="mt-3" style={{ color: "#a3a3a3", fontSize: 15 }}>
          WeaveOS sends webhook events to your server when workflow state changes,
  ...
  "data": {
    ...
    "settlement": {
      ...
      "settledAt": "2026-05-21T14:32:10Z"
        ...
        <p>
          Every delivery includes a <code>weaveos-signature</code> header containing
...
function verifyWebhook(rawBody, signatureHeader, secret) {
  ...
  if (Math.abs(Date.now() / 1000 - Number(parts.t)) > 300) {
    throw new Error("Timestamp too old (>5 min)");
        ...
        <h2>Retries</h2>
        <p>
          If your endpoint returns a non-2xx response or times out, WeaveOS retries
