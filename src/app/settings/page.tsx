    ...
    try {
      const r = await fetch(data.webhookUrl, {
        ...
        headers: {
          ...
          "X-Weaveos-Event": "WorkflowSettled",
          "X-Weaveos-Signature": "test-signature",
        },
        body: JSON.stringify({
          ...
          <div className="bg-[#171718] border border-[#1e1e1e] rounded-[20px] px-5 py-4 flex flex-col gap-3">
            ...
            <label className="flex flex-col gap-1.5">
              ...
              <input
                ...
                placeholder="https://your-app.example.com/webhooks/weaveos"
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <p className="text-[11px] text-[#5a5a5a]">
                ...
                <code className="font-mono">X-Weaveos-Signature</code> header on incoming webhooks.
              </p>
            </div>
          </div>
