...
export const metadata = {
  title: "Security — WeaveOS",
  description: "How WeaveOS protects your data and the integrity of every settlement.",
};
  ...
  return (
    ...
    >
      ...
      <LSection title="1. Security Philosophy">
        ...
        <LList>
          <LItem><strong className="text-white">Defence in depth.</strong> Multiple independent controls protect every critical operation. A compromised off-chain verifier cannot drain escrow funds because the Move smart contracts enforce independent invariants on-chain.</LItem>
          <LItem><strong className="text-white">Cryptographic finality.</strong> Settlement logic lives in audited Move smart contracts on the Sui blockchain. Once a settlement is verified and recorded on-chain, no off-chain actor — including us — can alter or reverse it.</LItem>
      ...
      <LSection title="2. Blockchain and Smart Contract Security">
        <LSub title="Sui Move Smart Contracts" />
        <LP>
        ...
        <LList>
          ...
          <LItem>Permissionless settlement: anyone can trigger settlement after the dispute window closes, preventing WeaveOS from unilaterally delaying payouts.</LItem>
          <LItem>All-or-nothing atomicity: settlement is executed in a single Programmable Transaction Block. Gas exhaustion or any failure reverts the entire transaction — no partial payments are possible.</LItem>
        </LList>
        ...
        <LP>
          The Move contract verifies the enclave&rsquo;s attestation before permitting settlement. A compromised application layer cannot forge a valid attestation without access to the enclave&rsquo;s key — and even then, Move-side invariants remain independently enforced.
        </LP>
        <LNote>
      ...
      <LSection title="7. Responsible Disclosure">
        ...
        <LList>
          <LItem>
            Email:{" "}
            <a href="mailto:security@weaveos.xyz" className="text-white underline underline-offset-2">
              security@weaveos.xyz
            </a>
          </LItem>
      ...
      <LSection title="9. Data Compliance Declarations">
        ...
        <LList>
          ...
          <LItem><strong className="text-white">Blockchain data:</strong> Sui wallet addresses, transaction hashes, on-chain object IDs, USDC amounts, settlement records.</LItem>
      ...
      <LSection title="10. Contact">
        <LP>
          ...
          <a href="mailto:team@weaveos.xyz" className="text-white underline underline-offset-2">
            team@weaveos.xyz
          </a>
          .
        </LP>
